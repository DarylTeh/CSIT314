...
<!-- Meta Tags --><!-- remember to comment because its "good practice" -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                <div class="row"><!-- remember to comment because its "good practice" -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <div  class="table-striped font-14 pb-2">
                                <table class="w-100"><!-- remember to comment because its "good practice" -->
                                    <tbody>
                                        <tr>
                                            <td>BHK :</td>
