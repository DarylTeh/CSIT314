...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1><!-- remember to comment because its "good practice" -->
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- remember to comment because its "good practice" -->
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12"><!-- remember to comment because its "good practice" -->
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- remember to comment because its "good practice" -->
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- remember to comment because its "good practice" -->
